...
Geokit::Geocoders::GoogleGeocoder.cryptographic_key = Rails.configuration.apis[:google_api]
...
Geokit::Geocoders::BingGeocoder.key = Rails.configuration.apis[:bing_api]
